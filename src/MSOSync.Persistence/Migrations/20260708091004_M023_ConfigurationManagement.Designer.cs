...
namespace MSOSync.Persistence.Migrations
{
    ...
    [Migration("20260708091004_M023_ConfigurationManagement")]
    partial class M023_ConfigurationManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncBatchError", b =>
                {
                    ...
                    b.HasIndex("ConflictType", "CreateTime")
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncConfigurationRollout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("TargetNodeCount")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_rollout_status");

                    b.ToTable("sync_configuration_rollout", "msosync");
                });
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncConfigurationTemplate", b =>
                {
                    ...
                    b.Property<int?>("CurrentPublishedVersion")
                        .HasColumnType("int")
                        .HasColumnName("current_published_version");
                    ...
                    b.Property<int?>("LatestDraftVersion")
                        .HasColumnType("int")
                        .HasColumnName("latest_draft_version");
                    ...
                    b.ToTable("sync_configuration_template", "msosync");
                });

            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncConfigurationTemplateVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("sync_configuration_template_version", "msosync");
                });
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncDataEvent", b =>
                {
                    ...
                    b.HasIndex("SourceNodeId")
                        .HasDatabaseName("IX_sync_data_event_source_node_id");

                    b.HasIndex("TransactionId")
                        .HasDatabaseName("IX_sync_data_event_transaction_id");

                    b.HasIndex("TriggerId")
                        .HasDatabaseName("IX_sync_data_event_trigger_id");

                    b.HasIndex("ChannelId", "CreateTime")
                        .IsDescending(false, true)
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncExportJob", b =>
                {
                    ...
                    b.HasIndex("RequestedBy", "CreatedAt")
                        .HasDatabaseName("IX_export_job_requested_by");

                    b.HasIndex("Status", "CreatedAt")
                        .HasDatabaseName("IX_export_job_status_created");

                    b.ToTable("sync_export_job", (string)null);
                });
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncIncomingBatch", b =>
                {
                    ...
                    b.HasIndex("SourceNodeId", "ReceivedTime")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_sync_incoming_batch_source_node_time");

                    b.HasIndex("Status", "ReceivedTime")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_sync_incoming_batch_status_time");

                    b.HasIndex("SourceNodeId", "ChannelId", "BatchSequence")
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncNode", b =>
                {
                    ...
                    b.Property<string>("AppliedEffectiveHash")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .HasColumnName("applied_effective_hash");

                    b.Property<int?>("AppliedTemplateVersion")
                        .HasColumnType("int")
                        .HasColumnName("applied_template_version");

                    b.Property<Guid?>("AssignedTemplateId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("assigned_template_id");

                    b.Property<int?>("AssignedTemplateVersion")
                        .HasColumnType("int")
                        .HasColumnName("assigned_template_version");

                    b.Property<string>("ConfigurationState")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("configuration_state");

                    b.Property<DateTime?>("ConfigurationStatusReportedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("configuration_status_reported_at");
                    ...
                    b.Property<string>("ExpectedEffectiveHash")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .HasColumnName("expected_effective_hash");
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncNodeConfigurationHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("sync_node_configuration_history", "msosync");
                });

            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncNodeConfigurationOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("OverrideSource")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("override_source");
                    ...
                    b.HasIndex("NodeId", "SettingKey")
                        .IsUnique()
                        .HasDatabaseName("UX_node_override_key");

                    b.ToTable("sync_node_configuration_override", "msosync");
                });
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncRegistrationRequest", b =>
                {
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_reg_request_status");
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncRolePermission", b =>
                {
                    ...
                    b.ToTable("sync_role_permission", "msosync");
                });
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncUserPreference", b =>
                {
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncConfigurationTemplateVersion", b =>
                {
                    b.HasOne("MSOSync.Persistence.Entities.SyncConfigurationTemplate", "Template")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("MSOSync.Persistence.Entities.SyncRolePermission", b =>
                {
                    b.HasOne("MSOSync.Persistence.Entities.SyncPermission", "Permission")
