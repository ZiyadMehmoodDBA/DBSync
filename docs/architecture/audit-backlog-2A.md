...
| 2A-029 | AppDbContext injected directly in 3 controllers (AuthController switch-tenant membership lookup, BatchController outgoing-batch queries, NodeLifecycleController node read) — RULE-ARCH-3 | 2A.5 | P2 | Complete (Phase 2B.1 Task 2 NodeLifecycleController + Task 7 AuthController/BatchController; controllers no longer inject AppDbContext) |
